...
--
-- Name: index_bookings_on_pet_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_bookings_on_pet_id ON public.bookings USING btree (pet_id);
...
--
-- Name: bookings fk_rails_8b3223e2a8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_rails_8b3223e2a8 FOREIGN KEY (pet_id) REFERENCES public.pets(id);
